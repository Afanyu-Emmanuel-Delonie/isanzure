...
from app.services.auth_service import hash_password, check_password, generate_jwt, generate_reset_token
...
def signup():
    ...
    user_id = create_user(data['name'], data['email'], data['phone'], hashed, role)
