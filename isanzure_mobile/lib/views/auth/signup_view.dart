...
class _SignupViewState extends State<SignupView> {
  ...
  Future<void> _submit() async {
    ...
    if (!_agreed) {
      AppToast.error(context, 'Please accept the terms to continue');
      return;
    }

    final viewModel = context.read<AuthViewModel>();
    final success = await viewModel.initiateSignup(
    ...
    if (success) {
      ...
      AppToast.error(context, viewModel.errorMessage ?? 'Signup failed');
    }
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AuthPasswordField(
                        ...
                        // Re-validate the confirm field whenever this one changes.
